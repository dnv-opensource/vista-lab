...
export class Client extends AuthorizedApiBase {
     ...
     * @return Success
     */
    dataChannelPostImportAndSimulate(body: SimulatorDataChannelListPackage | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/data-channel/import-and-simulate";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processDataChannelPostImportAndSimulate(_response);
        });
    }

    protected processDataChannelPostImportAndSimulate(response: Response): Promise<void> {
...
export interface SimulatorConfigurationReference {
    ID: string | undefined;
    Version: string | undefined;
    TimeStamp: Date | undefined;
}

export interface SimulatorDataChannel {
    DataChannelID: SimulatorDataChannelID;
    Property: SimulatorProperty;
}

export interface SimulatorDataChannelID {
    LocalID: string | undefined;
    ShortID: string | undefined;
    NameObject: SimulatorNameObject;
}

export interface SimulatorDataChannelList {
    DataChannel: SimulatorDataChannel[] | undefined;
}

export interface SimulatorDataChannelListPackage {
    Package: SimulatorPackage;
}

export interface SimulatorDataChannelType {
    Type: string | undefined;
    UpdateCycle: string | undefined;
    CalculationPeriod: string | undefined;
}

export interface SimulatorFormat {
    Type: string | undefined;
    Restriction: SimulatorRestriction;
}

export interface SimulatorHeader {
    ShipID: string | undefined;
    DataChannelListID: SimulatorConfigurationReference;
    VersionInformation: SimulatorVersionInformation;
    Author: string | undefined;
    DateCreated: Date | undefined;
}

export interface SimulatorNameObject {
    NamingRule: string | undefined;
}

export interface SimulatorPackage {
    Header: SimulatorHeader;
    DataChannelList: SimulatorDataChannelList;
}

export interface SimulatorProperty {
    DataChannelType: SimulatorDataChannelType;
...
export interface SimulatorRange {
    High: string | undefined;
    Low: string | undefined;
}

export interface SimulatorRestriction {
    Enumeration: string[] | undefined;
    FractionDigits: string | undefined;
    Length: string | undefined;
    MaxExclusive: string | undefined;
    ...
    Pattern: string | undefined;
    TotalDigits: string | undefined;
    WhiteSpace: SimulatorRestrictionWhiteSpace;
}

export enum SimulatorRestrictionWhiteSpace {
    _0 = 0,
    _1 = 1,
    _2 = 2,
}
...
export interface SimulatorVersionInformation {
    NamingRule: string | undefined;
    NamingSchemeVersion: string | undefined;
