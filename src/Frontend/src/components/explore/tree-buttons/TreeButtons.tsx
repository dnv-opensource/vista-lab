...
import { BusEvents, TreeAllDataChannelsStatusEvent, TreeAllNodesStatus, TreeAllNodesStatusEvent } from '../../shared/events';
    ...
    return (
        <div className={'tree-buttons'}>
            ...
            <ButtonWithIcon
                onClick={() => {
                    if (canExpandNodes)
                        dispatch({ type: BusEvents.TreeAllNodesStatus, action: nextForNodes });
